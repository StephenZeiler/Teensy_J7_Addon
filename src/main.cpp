...
const int INJECT_STEPS        = 810;  // Current setting is at 76mm travel...150mm is the circuference of the pulley. 1600 steps/rev.  1600/150mm = 10.6666 steps /mm desired in travel.. So if i want to travel 65mm INJECT_STEPS would be 10.6666*65 == 692. 
